...
const SOURCE_FILTER_LABEL_KEYS: Record<SourceFilter, string> = {
  ...
  company: "app.skills.companySkills.company",
...
function skillSettingsToastBody(skill: Pick<CompanySkillDetail, "categories" | "sharingScope">) {
  const sharing = skill.sharingScope === "private"
    ...
    : translate("app.skills.companySkills.settingsToast.sharingCompany");
    ...
    >
      <div className="flex items-start gap-3">
        ...
        {(() => {
          ...
          return (
            <span className="shrink-0 text-muted-foreground" title={t("app.skills.companySkills.fromSource", { source: meta.label })} aria-label={t("app.skills.companySkills.fromSource", { source: meta.label })}>
      ...
      <div className="mt-auto pt-3">
        ...
        <div className="flex items-center gap-2 text-(length:--text-micro) text-muted-foreground">
          <span>{card.agentCount === 1 ? t("app.skills.companySkills.oneAgent", { count: card.agentCount }) : t("app.skills.companySkills.manyAgents", { count: card.agentCount })}</span>
          {card.starCount > 0 ? (
            <>
    ...
    <div className="flex min-h-(--sz-calc-30) md:h-(--sz-calc-33) md:min-h-0 md:overflow-hidden">
      ...
      <aside className={cn("hidden w-60 shrink-0 flex-col overflow-hidden border-r border-border md:flex", showFolderRail && "md:hidden")}>
        <div className="border-b border-border px-4 py-4">
          <h2 className="text-sm font-semibold text-foreground">{t("app.skills.companySkills.skillsStore")}</h2>
          <p className="text-xs text-muted-foreground">{t("app.skills.companySkills.skillsStoreTagline")}</p>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2 border-b border-border px-4 py-3">
          <div className="flex h-9 min-w-(--sz-12rem) flex-1 items-center gap-2 rounded-md border border-border px-2.5">
            ...
            <input
              ...
              placeholder={t("app.skills.companySkills.searchPlaceholder")}
              ...
              <DropdownMenuTrigger asChild>
                <Button variant="outline" size="sm">
                  ...
                  <span className="ml-1.5 capitalize">
                    {sourceBadgeFilter === "all" ? t("app.common.labels.all") : sourceMeta(sourceBadgeFilter as CompanySkillSourceBadge, null).label}
                  </span>
                  <ChevronDown className="ml-1 h-3.5 w-3.5" />
                </Button>
              </DropdownMenuTrigger>
          ...
          <Button asChild variant="outline" size="sm">
            <Link to="/skills/studio">
              ...
              {t("app.skills.companySkills.studio")}
            </Link>
          </Button>
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
          ...
          <Tabs value={tab} onValueChange={(value) => onTabChange(value as DiscoveryTab)}>
            <TabsList variant="line" className="p-0">
              ...
              <TabsTrigger value="installed" className="px-3">
                <span>{t("app.common.states.installed")}</span>
              ...
              <TabsTrigger value="catalog" className="px-3">
                <span>{t("app.skills.companySkills.catalogLabel")}</span>
              ...
              <TabsTrigger value="bundled" className="px-3">
                <span>{t("app.skills.skillFolderTree.bundled")}</span>
      ...
      {step === 0 ? (
        ...
        <div className="space-y-4 text-sm">
          <div className="grid grid-cols-(--gtc-26) gap-y-2">
            ...
            <span>{draft.sharingScope === "private" ? t("app.common.labels.private") : t("app.skills.companySkills.company")}</span>
          ...
          <div className="space-y-2">
            ...
            <div className="grid gap-2 sm:grid-cols-3">
              {(["company", "private"] as const).map((scope) => (
                ...
                >
                  <span className="block font-medium">{scope === "company" ? t("app.skills.companySkills.company") : t("app.common.labels.private")}</span>
                  <span className="mt-1 block text-xs text-muted-foreground">
                    {scope === "company" ? t("app.skills.companySkills.wizard.visibleCompany") : t("app.skills.companySkills.wizard.visiblePrivate")}
                  </span>
                </button>
              ))}
              <button
          ...
          {defaultAction === "install" ? (
            <div className="rounded-md border border-border p-3">
              ...
              <p className="mb-2 text-xs text-muted-foreground">
                {t("app.skills.companySkills.install.enableHelpCompany")}
              </p>
              <AgentMultiSelect
                agents={agents}
                ...
                emptyMessage={t("app.skills.companySkills.noAgentsSupportSkillsCompany")}
...
function AttachAgentsPopover({
  ...
  return (
    <AgentMultiSelect
      ...
      emptyMessage={eligible.length === 0 ? t("app.skills.companySkills.noAgentsSupportSkillsCompany") : t("app.skills.companySkills.noAgentsYet")}
      isAgentDisabled={(agent) => {
        const option = agent as AttachAgentOption;
        return option.required || !option.supportsSkills;
      }}
          ...
          <div className="flex flex-wrap items-center justify-end gap-1">
            ...
            <div className="flex items-center overflow-hidden rounded-md border border-border">
              <Tooltip>
                ...
                <TooltipContent>{t("app.skills.companySkills.detail.installsTooltipCompany")}</TooltipContent>
              </Tooltip>
              <button
                type="button"
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              >
                <option value="company">{t("app.skills.companySkills.settings.scopeCompany")}</option>
            ...
            {detail.editable ? (
              <div className="rounded-md border border-destructive/40 p-3">
                ...
                <div className="mt-2 flex items-center justify-between gap-3">
                  <p className="min-w-0 text-xs text-muted-foreground">{t("app.skills.companySkills.settings.removeHelpCompany")}</p>
                  <Button
                    variant="destructive"
                    size="sm"
                    className="shrink-0"
...
export function CompanySkills() {
  ...
  const deleteSkill = useMutation({
    ...
    onSuccess: async (skill) => {
      ...
      pushToast({
        ...
        body: t("app.skills.companySkills.toast.removedBodyCompany", { name: skill.name }),
      });
    },
    onError: (error) => {
  ...
  if (!selectedCompanyId) {
    return <EmptyState icon={Boxes} message={t("app.skills.companySkills.page.selectCompany")} />;
  }
  ...
  const studioDescription = studioForkFromId
    ? t("app.skills.companySkills.page.forkDescriptionCompany")
    : t("app.skills.companySkills.page.createDescriptionCompany");
  return (
    <>
      {policyDenial.denial ? (
      ...
      <Dialog open={deleteOpen} onOpenChange={closeDeleteDialog}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              {t("app.skills.companySkills.remove.descriptionCompany")}
            </DialogDescription>
          </DialogHeader>
      ...
      <Dialog open={importDialogOpen} onOpenChange={setImportDialogOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              {t("app.skills.companySkills.source.importDescriptionCompany")}
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-3">
