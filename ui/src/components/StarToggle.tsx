...
export function StarToggle({
  ...
  const ariaLabel = starred
    ? t("app.shared.starToggle.unstar", { name: resourceName })
    : t("app.shared.starToggle.star", { name: resourceName });
  ...
  if (size === "button") {
    return (
      <Button
        ...
        disabled={pending}
        onClick={handleClick}
        title={error ? t("app.shared.starToggle.saveFailed") : undefined}
        className={cn(
          error
