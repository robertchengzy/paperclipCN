...
export function IssueSiblingNavigation({ navigation, linkState }: IssueSiblingNavigationProps) {
  ...
  return (
    <nav
      aria-label={t("app.issueUi.issueSiblingNavigation.ariaLabel")}
...
function SiblingLink({
  ...
  const label = direction === "previous" ? t("app.issueUi.issueSiblingNavigation.previous") : t("app.issueUi.issueSiblingNavigation.next");
  ...
  return (
    <Link
      ...
      aria-label={direction === "previous"
        ? t("app.issueUi.issueSiblingNavigation.previousAria", { identifier, title: issue.title })
        : t("app.issueUi.issueSiblingNavigation.nextAria", { identifier, title: issue.title })}
      className={cn(
