        ...
        <div ref={overlayRef} className="relative h-full w-full">
          {highlightRects.map((rect, index) => {
            ...
            return (
              <button
                ...
                data-focused={isFocused || undefined}
                data-hovered={isHovered || undefined}
                aria-label={t("app.issueUi.documentAnnotationLayer.openThread")}
                className={cn(
          ...
          {highlightRects.map((rect, index) =>
            rect.isTail && rect.anchorState === "stale" ? (
              <span
                ...
                title={t("app.issueUi.documentAnnotationLayer.anchorMoved")}
              >
          ...
          {pendingAnchor && toolbarPosition ? (
            <div
              ...
              role="toolbar"
              aria-label={t("app.issueUi.documentAnnotationLayer.selectionActions")}
            ...
            >
              <Button
                ...
                title={newCommentDisabled
                  ...
                  : t("app.issueUi.documentAnnotationLayer.addCommentOnSelection")}
              >
                <MessageSquarePlus className="h-3.5 w-3.5" aria-hidden="true" />
                {t("app.common.nouns.comment")}
              </Button>
            </div>
          ) : null}
        </div>
