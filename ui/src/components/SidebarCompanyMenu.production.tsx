    ...
    <DropdownMenu open={open} onOpenChange={handleOpenChange}>
      <DropdownMenuTrigger asChild>
        <Button
          ...
          aria-label={
            currentName
              ? t("app.settings.sidebarCompanyMenu.openNamedCompanySwitcher", { name: currentName })
              : t("app.settings.sidebarCompanyMenu.openCompanySwitcher")
          }
        >
          <span className="flex min-w-0 flex-1 items-center gap-2">
            ...
            >
              {currentName ?? t("app.settings.sidebarCompanyMenu.selectCompany")}
            </span>
          </span>
