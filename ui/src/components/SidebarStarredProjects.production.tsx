...
export function SidebarStarredProjects() {
  ...
  return (
    <div className="flex flex-col gap-0.5" aria-label={translateCopy("app.issueUi.sidebarStarredProjects.starredProjects")}>
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button
                    ...
                    aria-label={translateCopy("app.issueUi.sidebarStarredProjects.openActions", { name: project.name })}
                  >
                ...
                <DropdownMenuContent align="end" className="w-48">
                  ...
                  >
                    ...
                    <span>{translateCopy("app.issueUi.sidebarStarredProjects.removeFromStarred")}</span>
                  </DropdownMenuItem>
                  <DropdownMenuSeparator />
                  <DropdownMenuItem
                    onClick={() => {
                  ...
                  >
                    ...
                    <span>{translateCopy("app.issueUi.sidebarStarredProjects.leaveProject")}</span>
                  </DropdownMenuItem>
                </DropdownMenuContent>
              </DropdownMenu>
            ) : null}
