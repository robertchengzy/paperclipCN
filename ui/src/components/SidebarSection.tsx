    ...
    <DropdownMenu open={menuOpen} onOpenChange={setMenuOpen}>
      <DropdownMenuTrigger asChild>
        <button
          ...
          aria-label={menu?.ariaLabel ?? t("app.shell.sidebarSection.actions", { label })}
        >
          {headerContent}
        </button>
      </DropdownMenuTrigger>
        ...
        {collapsible ? (
          <CollapsibleTrigger asChild>
            <button
              ...
              aria-label={collapsible.open ? t("app.shell.sidebarSection.collapse", { value0: label }) : t("app.shell.sidebarSection.expand", { value0: label })}
            >
