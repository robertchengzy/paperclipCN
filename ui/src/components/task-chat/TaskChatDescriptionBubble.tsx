    ...
    return (
      ...
      >
        <InlineEditor
          ...
          placeholder={t("app.taskChat.taskChatDescriptionBubble.addDescription")}
          multiline
          defaultEditing
  ...
  if (!hasDescription) {
    ...
    return (
      ...
      >
        ...
        {t("app.taskChat.taskChatDescriptionBubble.addDescription")}
      </button>
    );
  }
      ...
      >
        ...
        {!isHuman ? (
          <button
            ...
            onClick={() => setEditing(true)}
            aria-label={t("app.taskChat.taskChatDescriptionBubble.editDescription")}
