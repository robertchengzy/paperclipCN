...
export function NewGoalDialog() {
  ...
  const levelLabel = (value: string) => t(`app.goals.levelLabel.${value}`, { defaultValue: value });
  ...
  const uploadDescriptionImage = useMutation({
    mutationFn: async (file: File) => {
      if (!selectedCompanyId) throw new Error(t("app.goals.detail.noOrgSelected"));
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-2.5 border-b border-border">
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <span>{newGoalDefaults.parentId ? t("app.goals.dialog.newSubGoal") : t("app.goals.dialog.newGoal")}</span>
          </div>
        ...
        <div className="px-4 pt-4 pb-2 shrink-0">
          <input
            ...
            placeholder={t("app.goals.dialog.titlePlaceholder")}
            value={title}
        ...
        <div className="px-4 pb-2 overflow-y-auto max-h-(--sz-50vh)">
          <MarkdownEditor
            ...
            placeholder={t("app.goals.dialog.descriptionPlaceholder")}
            bordered={false}
          ...
          <Popover open={parentOpen} onOpenChange={setParentOpen}>
            <PopoverTrigger asChild>
              <button className="inline-flex items-center gap-1.5 rounded-md border border-border px-2 py-1 text-xs hover:bg-accent/50 transition-colors">
                ...
                {currentParent ? currentParent.title : t("app.goals.dialog.parentGoal")}
              </button>
            </PopoverTrigger>
        ...
        <div className="flex items-center justify-end px-4 py-2.5 border-t border-border">
          ...
          >
            {createGoal.isPending ? t("app.goals.dialog.creating") : newGoalDefaults.parentId ? t("app.goals.dialog.createSubGoal") : t("app.goals.dialog.createGoal")}
          </Button>
        </div>
      </DialogContent>
    </Dialog>
