...
export function CompanySettingsSidebar() {
  ...
  return (
    <ContextualSidebarFrame
      surface="settings"
      title={t("app.common.nouns.settings")}
      showHeader={false}
    ...
    >
      ...
      >
        <div data-slot="settings-back-group" className={`${primarySidebarStyles.group} w-full`}>
          <SidebarNavItem to="/dashboard" label={t("app.settings.companySettingsSidebar.backToApp")} icon={ArrowLeft} />
        </div>
      </div>
      <nav
        aria-label={t("app.common.nouns.settings")}
