  ...
  return (
    ...
    >
      {isDragOver && canAttach ? (
        ...
        >
          <span className="inline-flex items-center gap-2">
            ...
            {t("app.taskChat.chatComposer.dropToAttach")}
          </span>
        </div>
      ) : null}
      ...
      <textarea
        ...
        placeholder={placeholder ?? t("app.taskChat.chatComposer.messagePlaceholder")}
        disabled={disabled}
        autoFocus={autoFocus}
        rows={1}
              ...
              attachment.status === "uploading"
                ...
                : attachment.status === "error"
                  ...
                  : attachment.inline
                    ...
                    : t("app.taskChat.chatComposer.attached");
            return (
              <div
                key={attachment.id}
                className={cn(
      ...
      <div className="mt-2 flex items-center gap-2">
        {canAttach ? (
          <>
            ...
            <button
              ...
              aria-label={t("app.taskChat.chatComposer.attachFiles")}
              title={t("app.taskChat.chatComposer.attachFiles")}
        ...
        <button
          ...
          disabled={!canSend}
          aria-label={sendLabel ?? t("app.taskChat.chatComposer.sendMessage")}
          title={sendLabel ?? t("app.taskChat.chatComposer.sendMessage")}
          className={cn(
