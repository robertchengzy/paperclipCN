...
export function workModeMetaList(): WorkModeMeta[] {
  return [
    {
      value: "standard",
      label: t("app.shared.workMode.auto"),
      icon: Hammer,
      tone: "neutral",
    ...
    {
      value: "planning",
      label: t("app.shared.workMode.plan"),
      icon: ClipboardList,
      tone: "planning",
    ...
    {
      value: "ask",
      label: t("app.shared.workMode.ask"),
...
export function titleForPendingWorkMode(mode: IssueWorkMode): string {
  if (mode === "ask") {
    return t("app.shared.workMode.pendingAsk");
  }
  if (mode === "planning") {
    return t("app.shared.workMode.pendingPlan");
  }
  return t("app.shared.workMode.pendingAuto");
}
