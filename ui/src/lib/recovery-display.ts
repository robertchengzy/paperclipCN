...
> = {
  needed: {
    ...
    icon: TriangleAlert,
    get label() { return t("app.shared.recovery.needed"); },
  },
  in_progress: {
    className:
      "border-sky-500/60 bg-sky-500/15 text-sky-700 dark:text-sky-300",
    icon: RefreshCw,
    get label() { return t("app.shared.recovery.inProgress"); },
  },
  observe_only: {
    className: "border-border bg-muted text-muted-foreground",
    icon: Eye,
    get label() { return t("app.shared.recovery.observing"); },
  },
  escalated: {
    className: "border-red-500/60 bg-red-500/15 text-red-700 dark:text-red-300",
    icon: OctagonAlert,
    get label() { return t("app.shared.recovery.escalated"); },
  },
};
