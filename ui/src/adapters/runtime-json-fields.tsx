...
export function RuntimeServicesJsonField({
  ...
  return (
    <Field label={t("app.agentUi.runtimeJsonFields.runtimeServicesJson")} hint={help.runtimeServicesJson}>
      <textarea
...
export function PayloadTemplateJsonField({
  ...
  return (
    <Field label={t("app.agentUi.runtimeJsonFields.payloadTemplateJson")} hint={help.payloadTemplateJson}>
      <textarea
